...
<div class="hero">
    <div class="container">
        ...
        <div class="top-controls">
            ...
            <a href="{{ '/ku' | relative_url }}" class="lang-btn">
                <span class="lang-desktop">کوردی (سۆرانی)</span>
                <span class="lang-mobile">KU</span>
            </a>
        </div>
        
        <div class="content-card">
            <h1 class="name">{{ site.data.content.en.name }} <span class="header-icons"><span class="tea-icon" title="Tea Time">🫖</span><span class="book-icon" title="Reading"></span></span></h1>
            ...
            <div class="social-links">
                <a href="{{ '/blog' | relative_url }}" class="social-btn" style="background: var(--accent-color);">
